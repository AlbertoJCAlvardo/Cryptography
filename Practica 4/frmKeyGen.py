...
class frmKeyGen(Frame):
    ...
    def __init__(self, master):
        ...
        self.ltitulo = Label(self, text="Generador de Llaves", font=('Palatino', 50), bg="#000000", 
                             fg = "#ffffff").grid(row=0, column=1,padx=50, pady=50)
        self.lName = Label(self, text="Nombre: ", font=('Palatino', 25), bg="#000000", 
                             fg = "#ffffff").grid(row=1, column=0,padx=10, pady=10)
        self.entName = Entry(self, width=25)
        self.op1 = Button(self, text="Generar Llave  ", font=('Georgia', 15), bg = "#000000", fg = "#ffffff",       
                  command=lambda: self.generarLlave()).grid(row=2,column=1, padx=10, pady=15)
        self.op1 = Button(self, text="Volver", font=('Georgia', 15), bg = "#000000", fg = "#ffffff",       
